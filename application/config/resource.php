...
$resource = array(
	...
	'会员管理'       => array('controller' => 'user', 'action' => 'affiliate_list,update_ping,update_class,advertiser_list,commercial_list,service_list,add_post,update_post,del,lock,unlock'),
	'用户组'          => array('controller' => 'group', 'action' => 'get_list,add_post,update_post,del,lock,unlock'),
	'所属平台'        => array('controller' => 'ping', 'action' => 'get_list,add_post,update_post,del,lock,unlock'),
	'所属类型'        => array('controller' => 'class', 'action' => 'get_list,add_post,update_post,del,lock,unlock'),
