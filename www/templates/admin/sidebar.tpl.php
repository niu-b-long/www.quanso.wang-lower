...
echo '    <div class="nav_list nav_list_active"><a href="javascript:;" class="list_a"  id=\'nav_tongji\'><i class="icon-other icon-black"></i>数据统计</a>' . "\r\n" . '      <div class="inner">' . "\r\n" . '        <p style="height:10px;"></p>' . "\r\n" . '        ' . "\r\n" . '         <p ';

echo '><a href="';
echo url('admin/tongji.get_list_token');
echo '">token管理</a></p>' . "\r\n" . '        <p ';
...
echo  '    <div class="nav_list nav_list_active"><a href="javascript:;" class="list_a"  id=\'nav_other\'><i class="icon-other icon-black"></i>其它管理</a>' . "\r\n" . '      <div class="inner">' . "\r\n" . '        <p style="height:10px;"></p>' . "\r\n" . '        ' . "\r\n" . '         <p ';
