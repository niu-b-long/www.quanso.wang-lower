...
foreach ((array) $domain as $c ) {
	...
	echo $c['dname'];
	echo '</td>' . "\r\n" . '            <td>';
	$pingname = dr('admin/ping.get_one',$c['pingid']);
	echo $pingname['pingname'];
	echo '</td>' . "\r\n" . '            <td>';
	$classname = dr('admin/class.get_one',$c['classid']);
	echo $classname['classname'];
	echo '</td>' . "\r\n" . '            <td classid=\'';

	echo $c['id'];
	echo '\' class="uld_img"><a href="';
	echo url('admin/domain.edit?id=' . $c['id']);
	echo '"><img src="';
	echo SRC_TPL_DIR;
