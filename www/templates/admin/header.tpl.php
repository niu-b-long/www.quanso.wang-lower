...
echo '<link rel="shortcut icon" href="../logo.ico" />';
...
echo url('index');
echo '" target="_blank"> <i class="icon-home icon-white" style="margin-top: -2px;vertical-align: text-top;" ></i><span>优优传媒系统</span><span class="vs"></span> </a>' . "\r\n" . '  <ul class="nav_m"  >' . "\r\n" . '    <li class="dropdown"> <a  class="dropdown-toggle" href="';
