...
<title>账户注册-<?php echo $GLOBALS['C_ZYIIS']['sitename']?></title>
...
<link rel="stylesheet" type="text/css" href="<?php echo SRC_TPL_DIR?>/images/style2.css">
<style>
...
<div class="super" id="features">
        <div class="j-wrap clearfix">
          <div class="j-clause">
<form action="/index.php?e=index.post_register" method="POST" class="form-horizontal" id="form_b">
  <table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class="register" style="margin-top:20px">
    <tbody><tr>
      <td>        <h2>用户注册</h2></td>
    </tr>
    <tr>
      <td height="30">请填写下列表单信息，标<font color="#FF0000">*</font>为必填项目。
    ...
    <tr>
      <td height="40">       <label class="pfl pfl_act" for="rd1">
    ...
    <tr>
      <td><div style="background-color:#FAFAFA;border:1px solid #CCCCCC;height:200px; overflow:auto;padding:5px;text-align:left;width:900px; margin-left:2px"> 一、合作协议的确认和接纳<br />
        ...
        <p>十一、<?php echo $GLOBALS['C_ZYIIS']['sitename']?>欢迎联盟成员对网站服务条款给予评论或提出质疑。<br />
                <?php echo $GLOBALS['C_ZYIIS']['sitename']?> 将根据网站发展的需求和技术的发展不断完善本合作协议。<br />
          警告： <br />
