...
<div id="main" style="padding-top:10px;">
  <div class="breadcrumbs mt30">
   ...
   <form action="
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="zone_form controls">
          ...
          <tr>
            ...
            <td>  <?php if(RUN_ACTION == 'create') {?>
              <select style="width:159px; height:30px;" name="adtplid" id="adtplid" style="padding:5px;  ">
	...
	<div class="form-actions" style="margin-top:60px; margin-bottom:60px; margin-left: 260px;">
