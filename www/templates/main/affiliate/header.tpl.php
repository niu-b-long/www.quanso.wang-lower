    ...
    <div class="user">
      <ul class="icon-nav">
        ...
        <li class="dropdown" title="消息"> <a href="<?php echo url("affiliate/msg.get_list")?>" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-msg"></i> <span class="label label-lightred"><?php echo $GLOBALS ['read_num']?></span> </a> </li>
         ...
         <li class="dropdown" title="客服"> <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php  echo $GLOBALS ['service_qq'];?>&site=qq&menu=yes" target="_blank"  class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-kf"></i> <?php  echo $GLOBALS ['service_name'];?> ：<?php  echo $GLOBALS ['service_qq'];?></a> </li>
         <?php }?>
